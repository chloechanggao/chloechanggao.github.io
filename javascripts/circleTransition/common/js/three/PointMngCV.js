...
PointMngCV = (function() {
    ...
    */
    function PointMngCV(_v, _id, _obj, _randomNum) {
        ...
        var _degs = [_id * 14, _id * 15, _id * 13, _id * 19];
        ...
        var shapes = [{
            ...
            {
                _deg: _degs[2],
                _tx: Math.cos(_degs[2] * Math.PI / 90) * this._rad,
                _ty: Math.sin(_degs[2] * Math.PI / 10) * this._rad,
            },
            {
                _deg: _degs[3],
        ...
        console.log(shapes[index]._tx);

        this._trgV.x = shapes[index]._tx * 1.3;
        this._trgV.y = shapes[index]._ty * 1.3;
